...
class MongoDB(object):
	...
	def do_server_status(self):
		...
		# page faults
		if ('extra_info' in server_status) and ('page_faults' in \
			server_status['extra_info']):
				self.submit('counter', 'page_faults', \
					server_status['extra_info']['page_faults'])
		
		# global lock
		if 'globalLock' in server_status:
			self.submit('queue_length', 'readers_queued', server_status\
				['globalLock']['currentQueue']['readers'])
			self.submit('queue_length', 'writers_queued', server_status\
				['globalLock']['currentQueue']['writers'])
			self.submit('queue_length', 'readers_total', server_status\
				['globalLock']['activeClients']['readers'])
			self.submit('queue_length', 'writers_total', server_status\
